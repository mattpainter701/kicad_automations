...
WiFi-enabled environmental sensor — ESP32 + BME280 with dual-rail power
...
```
  ...
  U1 -> [VDD_3P3] -> U2, U3, U4, RP1
```

## BOM Summary

- **Placed components:** 6
- **Support passives (bypass caps, straps):** 21
- **Total pins:** 68
...
|-------|---------|---------------|---------------------|
| `IoT_Sensor_Node.kicad_sch` | 27 | 0 | 1 |
