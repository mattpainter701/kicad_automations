...
def _generate_summary_card(project_name: str, version: str, score_result: Any) -> str:
    ...
    <div class="summary-grid">
      <div class="card">
        ...
        <p style="font-size: 2.5em; color: var(--primary);">{score_result.overall:.1f} <span style="font-size: 0.6em;">({score_result.grade})</span></p>
...
"""
    ...
    if score_result.power_integrity < 75:
        recommendations.append(
            "Add bulk capacitors (10-100µF) on main power rails and increase decoupling capacitor coverage on all IC power pins."
        )
    if score_result.signal_integrity < 75:
        recommendations.append(
            "Add pull-up resistors on I2C/SPI buses and verify differential pair length matching for high-speed signals (USB, LVDS, etc.)."
        )
...
def _generate_footer() -> str:
    ...
    <p style="font-size: 0.8em;">This report is a design review aid and should be reviewed by qualified engineers before fabrication.</p>
  </footer>"""
