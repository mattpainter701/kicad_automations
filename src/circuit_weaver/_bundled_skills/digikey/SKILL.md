...
name: digikey
description: >
  Search DigiKey by keyword or part number, check stock and price breaks, retrieve
  component specifications, and download or synchronize datasheets for an electronics
  project. Use when the user explicitly wants DigiKey data, a DigiKey prototype-order
  comparison, or direct datasheet synchronization. For distributor-neutral sourcing,
  multi-vendor price comparison, or order-file generation, use the bom skill instead.
---
