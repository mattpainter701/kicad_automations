...
demo_frames = [
    ...
    {
        "type": "terminal",
        "title": "Step 2: Requirements Capture (Open-Ended)",
        "duration": 5,
        "content": [
            "[?] What does this circuit do?",
            "> WiFi environmental sensor — battery-powered, outdoor use",
            "",
            "[?] Input power source?",
            "> 3.7V LiPo battery with solar charging",
            "",
            "[?] Interfaces/buses?",
            "> WiFi (ESP32), I2C for sensor, USB-C for programming",
            "",
            "[?] Key components?",
            "> BME280 (temp/humidity), maybe soil moisture sensor",
            "",
            "[✓] Requirements captured. Now researching reference designs...",
        ],
    },
    {
        "type": "terminal",
