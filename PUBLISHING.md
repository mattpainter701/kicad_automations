...
4. Create an annotated tag that exactly matches the package version:
   ...
   git switch main
   git pull --ff-only
   git tag -a v0.33.1 -m "circuit-weaver 0.33.1"
...
.wheel-test/bin/python -m pip install "dist/circuit_weaver-0.33.1-py3-none-any.whl[test]"
...
.pypi-smoke/bin/python -m pip install --no-cache-dir "circuit-weaver[mcp]==0.33.1"
